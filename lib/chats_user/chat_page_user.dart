...
class ChatPageUser extends StatefulWidget {
  ChatPageUser({super.key, required this.userChat});
  UserChatModel userChat;
  @override
  State<ChatPageUser> createState() => _ChatPageStateUser();
}

class _ChatPageStateUser extends State<ChatPageUser> {
